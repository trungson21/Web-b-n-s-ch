document.getElementById("form-addtocart-url").addEventListener("submit", function(event) {
    // Ngăn chặn việc gửi form mặc định
    event.preventDefault();
    
    // Lấy giá trị của trường input idVaoDay
    var idVaoDayValue = document.getElementById("idVaoDay-url").value;
    
    // Tạo đối tượng FormData từ form
    var formData = new FormData(this);
    
    // Thêm giá trị idVaoDay vào formData
    formData.append("idVaoDay-url", idVaoDayValue);
